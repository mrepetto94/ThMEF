...
\hline
\sideset{_q}{_1}p & 46.870.020,00 & \text{Consolidated cost of employees} \\
\hline
\sideset{_q}{_2}p & 7.159.194,00 & \text{Consolidated tax liability} \\
\hline
\sideset{_o}{_1}n & 0,00 & \text{Distributor profit allocation} \\
\hline
\sideset{_o}{_2}n & 0,00 & \text{Manufacturer profit allocation} \\
\hline
\sideset{_o}{_3}n & 0,00 & \text{Principal profit allocation} \\
\hline
\end{tabular}
\end{center}
