...
\[ \min_{p,n} \quad \sum_{i=1}^{Q} (\sideset{_q}{_i}p \cdot w_i) + w_3 \cdot \sum_{i=1}^{N} ( \sideset{_n}{_i}n + \sideset{_n}{_i}p ) + w_4 \cdot \sum_{i=1}^{O} (\sideset{_o}{_i}n+\sideset{_o}{_i}p) \]


\begin{numcases}{Subject \quad to}
   \sum_{q=1}^{N} C_q(E,A,K) - p_1 = 0
   \\
   \sum_{q=1}^{N} T_q(R,E,A,K) - p_2 = 0 
   \\
   P_k(R,E,A,K)+nn_k-np_k=V_k  \qquad \forall k \in \left\{1...N\right\}
   \\
    \sum_{q=1}^{N} f_1\cdot(R_q-C_q(E,A,K))+nm_1-pm_1 = j_1\cdot \sum_{q=1}^{N} (R_q-C_q(E,A,K))  
   \\
    \sum_{q=1}^{N} f_2\cdot(R_q-C_q(E,A,K))+nm_2-pm_2 = j_2\cdot \sum_{q=1}^{N} (R_q-C_q(E,A,K)) 
   \\
    \sum_{q=1}^{N} f_3\cdot(R_q-C_q(E,A,K))+nm_3-pm_3 = j_3\cdot \sum_{i=q}^{N} (R_q-C_q(E,A,K)) 
   \\
