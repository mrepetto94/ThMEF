...
This approach seems to fit better in reality since, in reality, we tend to have a more than one objective most of the time in contrast with one another. 
...
\begin{numcases}{Subject \quad to}
   ...
   n_q,p_q\geq0 & q=1,...,Q
   \\
   pn_n,pp_n\geq0 & n=1,...,N
\end{numcases}

As you can see the (2)(3)(4) belongs to the first category, where instead (5) belongs to the second category, the latter in fact depend on the strategy of the decision maker and it's not given by any environmental variable.
...
Even if this three variable does not represent the full cost structure of each enterprise (cost of good sold was not mentioned) is helpful for the decision maker to take into account this three driver of cost since this information constitutes the main driver to address value adding activities in the overall value chain.
