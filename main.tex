...
\begin{numcases}{Subject \quad to}
   ...
   \\
    \sum_{k=1}^{N} f_1(R_k)+n_3-p_3 = w_1 R  
   \\
    \sum_{k=1}^{N} f_2(R_k)+n_4-p_4= w_2 R  
   \\
    \sum_{k=1}^{N} f_3(R_k)+n_5-p_5 = w_3 R  
   \\
...
\subsection{Revenue split}
This objective is represented by the goals (5)(6)(7) and the methodology used to determine this type of split is mutuated from the profit split method used in transfer pricing analysis. In particular the transfer pricing profit split aims at: determining the division of profits that independent enterprises would have expected to realize from engaging in the transaction or transaction. In our case we'll use this method and particularly the contribution analysis to define the effort of each funtional category in the value chain. Secondly we'll use this value driver to split the revenues in order to have, at the end a structure that takes into account the internal value chain of the products.
