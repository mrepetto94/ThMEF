...
\begin{center}
\begin{tabular}{ || m{10em} m{21em}|| }
 \hline
 Author & Novelty \\ 
 \hline\hline
 Ijiri and Kaplan (1971)\cite{ijiriy._amodel_1971} & The authors proposed a lexicographic approach to set a perfect sampling policy in auditing according to four objectives, namely: representative, corrective, protective and preventive sampling \\
 \hline
 Tayi and Gangolly (1985)\cite{Tayi1985} & The authors, building on what proposed in the filed of audit sampling, proposed instead of a lexicographic GP, a sapling based on a new approach, namely a polynomial GP which guarantees a better contemplation of the trade-offs between objectives \\
\hline
 Killough and Souders (1973)\cite{Tayi1985} & The authors apply the GP in the field of audit staff planning\\
\hline
Welling (1977)\cite{Welling1977} & The author proposes a GP approach to solve the problem of human resource evaluation using non monetary based parameters \\
\hline
 (1985)\cite{Tayi1985} & Application of GP in the auditing field, the authors proposed instead of a lexicographic GP in sapling a new approach based on polynomial GP which guarantees a better contemplation of the trade-offs between objectives \\
\hline
 Tayi and Gangolly (1985)\cite{Tayi1985} & Application of GP in the auditing field, the authors proposed instead of a lexicographic GP in sapling a new approach based on polynomial GP which guarantees a better contemplation of the trade-offs between objectives \\
\hline
 Tayi and Gangolly (1985)\cite{Tayi1985} & Application of GP in the auditing field, the authors proposed instead of a lexicographic GP in sapling a new approach based on polynomial GP which guarantees a better contemplation of the trade-offs between objectives \\
\hline
 Tayi and Gangolly (1985)\cite{Tayi1985} & Application of GP in the auditing field, the authors proposed instead of a lexicographic GP in sapling a new approach based on polynomial GP which guarantees a better contemplation of the trade-offs between objectives \\
