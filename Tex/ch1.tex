...
\begin{center}
 \begin{tabular}{||c c||} 
 \hline
 Author & Novelty \\ [0.5ex] 
 \hline\hline
 Ijiri and Kaplan (1971) & \multicolumn{2}{p{4cm}|}{\reggedright}The first proposition o GP in the audit field, the author proposed a lexicographic approach to set a perfect sampling policy in order to create an \\
 \hline
\end{tabular}
\end{center}
