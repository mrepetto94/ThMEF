...
\\
Lastly the management field which accounts for a great number of application, especially in the field of ... Concerning this field the brand new researches focuses on...
\\
 \begin{tikzpicture}
 \draw (0,0) circle (1.25) (0,0)  node [text=black,above] {Engeneering}
(3,0) circle (1.25) (3,0)  node [text=black,above] {Social sciences}
(1.5,-3) circle (1.25) (1.5,-3) node [text=black,above] {Management} 
(1.5,-1.15) circle (1.25) (1.5,-1.5) node [text=black,above] {Accounting} 	
\end{tikzpicture}
\\ 
All the three fields proposed in case of corporation modeling has a commpon backbone in which they gather information which is called accounting, embracing significant development in particular in areas dealing with, cost controlling, budgetting and operations planning; such cross literature will be treated in the following section.
